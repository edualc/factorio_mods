...
local get_badge = function(rank,top,left,rc)
    ...
    local img = {
                    filename = "__CustomHeroTurrets__/graphics/entity/turret/hr-hero-"..rank.."-base.png",
                    priority = "high",
                    line_length = 1,
                    width = 46,
                    height = 48,
...
local local_create_turret = function(turret,rank,rank_string,mod)
		...
		{   
           {
            icon = "__CustomHeroTurrets__/graphics/icons/hero-"..ir.."-icon.png",
			icon_size = 64,
            tint = tint
           }
		}
        ...
        --if turret.recipe ~= nil  then
            recipe = {
                ...
                categories = turret.recipe.categories,
