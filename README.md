...
- Balance: cluster member effective HP scales with both a base multiplier (×4, restoring ~vanilla HP) and evolution `(1 + 2×evo)` — ×1 at evo 0, ×2 at evo 0.5, ×3 at evo 1.0; a basic turret kills ~1 per shot early-game and needs multiple shots late-game, making attack damage progressively more important
