...
- Added safe-zone overlay shortcut (`zomtorio-safe-zones`, shield icon): draws semi-transparent green circles (radius 12 tiles, matching the lamp spawn-suppression radius) around every powered lamp near each player. Always available, no technology required. Refreshes every 5 seconds. Helps plan lamp coverage before nightfall
