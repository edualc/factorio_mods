...
heroturrets_wiki = 
{
	name = "CustomHeroTurrets",
	title    = "Hero Turrets",		
	mod_path =  "__CustomHeroTurrets__",		
	{
		...
		topic = {
			...
			{				
				...
				filepath = "__CustomHeroTurrets__/thumbnail.png",
				width = 144,
				height = 144,
				scale = 1
			},
		...
		topic = {
			...
			{				
				type = "image", 
				name = "ht-1-img",
				filepath = "__CustomHeroTurrets__/graphics/entity/turret/hr-hero-1-base.png",
				width = 46,
				height = 48,
				scale = 1
			},
			--{type = "text", text = "" },
			--{type = "line"},
			{type = "custom", interface = "CustomHeroTurrets", func = "hero_1_detail"}
		}
	},{
		...
		topic = {
			...
			{				
				type = "image", 
				name = "ht-2-img",
				filepath = "__CustomHeroTurrets__/graphics/entity/turret/hr-hero-2-base.png",
				width = 46,
				height = 48,
				scale = 1
			},
			--{type = "text", text = "" },
			--{type = "line"},
			{type = "custom", interface = "CustomHeroTurrets", func = "hero_2_detail"}
		}
	},{
		...
		topic = {
			...
			{				
				type = "image", 
				name = "ht-3-img",
				filepath = "__CustomHeroTurrets__/graphics/entity/turret/hr-hero-3-base.png",
				width = 46,
				height = 48,
				scale = 1
			},
			--{type = "text", text = "" },
			--{type = "line"},
			{type = "custom", interface = "CustomHeroTurrets", func = "hero_3_detail"}
		}
	},{
		...
		topic = {
			...
			{				
				type = "image", 
				name = "ht-4-img",
				filepath = "__CustomHeroTurrets__/graphics/entity/turret/hr-hero-4-base.png",
				width = 46,
				height = 48,
				scale = 1
			},
			--{type = "text", text = "" },
			--{type = "line"},
			{type = "custom", interface = "CustomHeroTurrets", func = "hero_4_detail"}
		}
	}
}